...
class TestFG2_399(unittest.TestCase):
    ...
    def setUp(self):
        dat_fg2_399 = pkg_resources.resource_filename(pkg, "data/FG2_399.csv")
...
class TestGP5W_270(unittest.TestCase):
    ...
    def setUp(self):
        dat_gp5w_270 = pkg_resources.resource_filename(pkg, "data/GP5W_270.csv")
...
class TestGP5W_260(unittest.TestCase):
    ...
    def setUp(self):
        dat_gp5w_260 = pkg_resources.resource_filename(pkg, "data/GP5W_260.csv")
        self.reader = readers.GP5W()
